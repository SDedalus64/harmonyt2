...
feat: add EntryForm and ResultSummary components with debouncing hook
[2025-07-08]
feat: add EntryForm and ResultSummary components with debouncing functionality

- Introduced EntryForm component for user input on HTS code, declared value, freight cost, unit count, and USMCA origin toggle.
- Added ResultSummary component to display estimated duties and landed costs.
- Implemented useDebounce hook to manage input delays, enhancing performance and user experience.
- Updated LookupScreen to integrate new components and improve overall functionality.feat: add EntryForm and ResultSummary components with debouncing hook
...
- Introduced EntryForm component for user input on HTS code, declared value, freight cost, unit count, and USMCA origin toggle.
- Added ResultSummary component to display estimated duties and landed costs.
- Implemented useDebounce hook for managing input delays, enhancing performance and user experience.
- Introduced EntryForm component for user input on HTS code, declared value, freight cost, unit count, and USMCA origin toggle.
- Added ResultSummary component to display estimated duties and landed costs.
- Implemented useDebounce hook for managing input delays, enhancing performance and user experience.
