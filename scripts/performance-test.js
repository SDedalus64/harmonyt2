...
function displayTestCodes() {
  ...
  testConfig.testHtsCodes.forEach((test, index) => {
    console.log(`${index + 1}. ${test.code} (${test.country}) - ${test.description}`);
  });
  console.log('');
}
...
function displayExpectedBehavior() {
  ...
  console.log('   - Console: "📡 Fetching from: https://harmonytariff.blob.core.windows.net/..."');
...
function main() {
  ...
  console.log('🎉 Ready to test! Launch the app and follow the test plan above.');
