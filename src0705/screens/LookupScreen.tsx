          ...
          <View style={styles.resultsHeaderLeft}>
            ...
            {result.description && (
              <TouchableOpacity
                ...
                onPressOut={() => setDescriptionExpanded(false)}
                delayLongPress={200}
              >
                <Text
                  style={[
        ...
        >
          ...
          {unitCount && parseFloat(unitCount) > 0 && (
            <View style={styles.compactSection}>
              ...
              {/* Landed cost per unit - only show if freight cost is provided */}
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    fontSize: getResponsiveValue(
      ...
      getTypographySize("md") * 1.8,
    ), // 25% smaller than doubled size
  ...
  suggestionItem: {
    paddingVertical: getResponsiveValue(6, 10), // Reduced padding for smaller text
  ...
  suggestionCode: {
    ...
    ), // 50% smaller - back to normal size
  ...
  suggestionDescription: {
    fontSize: getResponsiveValue(10, getTypographySize("sm") * 1.1), // 50% smaller
